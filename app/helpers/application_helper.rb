...
module ApplicationHelper
  ...
  def getclicky_javascript(site_id)
    return unless Rails.env.production?
    <<-eos
      <script type="text/javascript">
      ...
      <a title="Web Analytics" href="http://getclicky.com/218057"></a>
      <noscript><p><img alt="Clicky" width="1" height="1" src="http://in.getclicky.com/218057ns.gif" /></p></noscript>
    eos
  end
